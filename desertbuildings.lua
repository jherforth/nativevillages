...
local desert_village_noise = {
    offset = 0.0,
    scale = 0.095,          -- Controls village density inside clusters
    spread = {x = 220, y = 220, z = 220},  -- Village size & spacing
...
central_noise.scale = 0.045  -- about half as common as houses
